...
<body>
    ...
    <div class="container mt-5">
        ...
        <p class="lead text-center">
            Welcome to <strong>StoriesFun!</strong> We are passionate about sharing stories that inspire and entertain.
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                ...
                <p>
                    At StoriesFun, we believe that everyone has a story to tell. Our mission is to provide a platform
                    for
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                ...
                <p>
                    ...
                    They are the threads that weave the fabric of our shared humanity. At StoriesFun, we are committed
